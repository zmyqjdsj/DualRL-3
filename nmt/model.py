...
class NMT(object):      #定义了NMT这个类
    ...
    def __init__(self, mode, params, src_vocab_size, tgt_vocab_size,
        ...
        self.src_vocab_size = src_vocab_size    #src是编码器的输入，tgt是解码器的输入
        ...
        encoder_decoder_type = self.params.get("encoder_decoder_type", "bilstm") #encoderdecoder模式参数获得
        #Bi-directional Long Short-Term Memory前向LSTM与后向LSTM
        ...
        # only save NMT vars when dual training  vars means 变量或者增值
